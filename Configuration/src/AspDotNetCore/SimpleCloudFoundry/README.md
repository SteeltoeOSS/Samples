...
The cf push will create an app in the space by the name `foo-sample` and will bind the `myConfigServer` service instance to the app. You can hit the app @ `https://foo-sample.x.y.z/`.
