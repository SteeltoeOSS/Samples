...
Fire up a browser and open {uri-sample}.  Once on the home page, navigate to the {uri-sample}/Home/ConfigServer[Config Server Data, window="_blank"] tab and you'll see the values stored in the github repository used for the Spring Cloud Config Server samples.
