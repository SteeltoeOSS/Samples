# SimpleCloudFoundry - ASP.NET MVC Sample Application

ASP.NET MVC sample app illustrating how to use [Config Server for Pivotal Cloud Foundry](https://docs.pivotal.io/spring-cloud-services/config-server/) as a configuration source.
...
1. Select the SimpleCloudFoundry project in the solution and build it.
1. Right-click and select Publish
1. Publish the using the provided `FolderProfile`
1. Open your preferred command prompt and `cd` into the `SimpleCloudFoundry` folder
