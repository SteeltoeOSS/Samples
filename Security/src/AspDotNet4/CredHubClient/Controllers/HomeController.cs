...
namespace CredHubClient.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<ActionResult> TestItAll()
        {
            // values
            ...
            return Json("Look at Controllers/HomeController.cs to see what just completed successfully", JsonRequestBehavior.AllowGet);
        }
    }
}