...
using Steeltoe.Samples.Client.Models;
...
namespace Steeltoe.Samples.Client.Controllers;
...
public sealed class HomeController(IHttpClientFactory clientFactory, ILogger<HomeController> logger) : Controller
{
    ...
    private const string FrontendHostname = "steeltoe-samples-client";
    private const string BackendHostname = "steeltoe-samples-server";
