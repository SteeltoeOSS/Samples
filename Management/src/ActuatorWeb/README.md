...
1. Installed Tanzu Platform for Cloud Foundry
2. Installed Apps Manager
3. Installed MySql or Cloud Service Broker Tile
4. Optionally install [Metric Registrar for PCF](https://docs.pivotal.io/platform/application-service/2-9/metric-registrar/index.html).
