...
3. Installed RabbitMQ CloudFoundry service
...
Note: The provided manifest will create an app named `rabbit-connector` and attempt to bind to the the app to RabbitMQ service `myRabbitService`.

# What to expect - CloudFoundry

After building and running the app, you should see something like the following in the logs. 

To see the logs as you startup and use the app: `cf logs rabbit-connector`
