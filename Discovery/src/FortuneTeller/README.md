...
1. Start a Eureka [docker container](https://github.com/SteeltoeOSS/Samples/blob/4.x/CommonTasks.md) (pick the one for discovery-first, but omit the `-e eureka.instance.hostname=localhost` switch)
